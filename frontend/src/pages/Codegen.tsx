  ...
  return (
    ...
    <Header />
     <div className="flex min-h-screen w-full">
      <div className="flex flex-col items-center justify-center gap-6 bg-gray-100 p-8  md:w-3/4 overflow-y-auto">
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Legacy to Modern Code Converter</h1>
      ...
      <div className="flex flex-col items-center justify-center gap-6 bg-gray-50 p-8  md:w-1/4 overflow-y-auto">
        <h2 className="text-2xl font-bold tracking-tight sm:text-3xl">Conversion History</h2>
